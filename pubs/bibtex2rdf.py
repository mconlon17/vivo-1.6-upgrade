...
"""
    ...
    --  Optionally send a notification email to each author congratulating
        them on their paper, asking them confirm authorship (and potentially
        confirm use of CTSI resources)
"""
